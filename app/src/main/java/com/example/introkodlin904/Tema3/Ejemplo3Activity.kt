package com.example.introkodlin904.Tema3
...
class Ejemplo3Activity : AppCompatActivity() {
    ...
    fun controlar(view: android.view.View){
        ...
        if (valor==num){
            ...
            val notificacion = Toast.makeText(this,"El número es mayor",Toast.LENGTH_LONG)
            notificacion.show()
        }
        else{
            val notificacion = Toast.makeText(this,"El número es menor",Toast.LENGTH_LONG)
            notificacion.show()
        }
    }
